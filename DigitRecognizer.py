...
pygame.display.set_caption("Digit Recognizer By Tanush M M")
    ...
    for event in pygame.event.get():
        ...
        if event.type == MOUSEBUTTONUP:
            ...
            if PREDICT:
                ...
                textRecObj = textSurface.get_rect() #testing   
                textRecObj.left , textRecObj.bottom = rect_min_x, rect_max_Y #rect_min_x, rect_max_Y
